...
import { Sample, sampleMapper, SampleOrmEntity, sampleRecord } from './testing/sample.fixture.js';
...
describe('TypeOrmBaseRepository', () => {
	...
	it('findById should map the record to an aggregate or return null', async () => {
		orm.findOne.mockResolvedValueOnce(sampleRecord('id-1', 'A', { isActive: false }));
